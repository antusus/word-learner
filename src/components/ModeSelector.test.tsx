...
describe('ModeSelector', () => {
  it('renders the heading', () => {
    render(<ModeSelector modes={mockModes} onSelect={() => {}} onBack={() => {}} />)
  ...
  it('calls onSelect with the mode when clicked', async () => {
    ...
    render(<ModeSelector modes={mockModes} onSelect={onSelect} onBack={() => {}} />)
  ...
  it('calls onBack when back button is clicked', async () => {
    const user = userEvent.setup()
    const onBack = vi.fn()
    render(<ModeSelector modes={mockModes} onSelect={() => {}} onBack={onBack} />)
